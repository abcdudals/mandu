...
<link rel="stylesheet" type="text/css" href="resources/myLib/mbuyer.20211006.css">
...
<div id="wrap">
	...
	<div id="container">
		<div class="sale_container">
			<div>
				<h1 class="sale_header">Shopping Basket</h1>
				...
				<div class="sale_content">
					<div class="slide" style="width: 1024px; margin-right: 29px; display: inline-block; white-space: normal;">
						<ul>
							<c:forEach var="list" items="${BasketItem}">
							<li>
								<div class="b_card">
									<a href="">
										...
										<div class="card_content">
											...
											<div class="card_number">
												<span>
													<strong class="strong_number"><fmt:formatNumber value="${list.itemCount}"/></strong>개
												</span>
											</div>
										</div>
									</a>
